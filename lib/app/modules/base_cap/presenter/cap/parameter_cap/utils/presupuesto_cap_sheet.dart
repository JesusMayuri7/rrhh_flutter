...
void presupuestoCapSheet(Workbook workbook, int firstRowHeading,
  ...
  _proyeccion(4, 22, presupuestoSheet, presupuestoSheet.getLastRow() - 1,
      sheetBase.getLastRow());
...
_proyeccion(int _firstRowBase, int _column, Worksheet page, int _rowEnd,
  ...
  for (int x = _firstRowBase; x < _rowEnd - 1; x++) {
    ...
    page.getRangeByIndex(_firstRowCertificado, _column + 2).formula =
        '''=IF(TRIM(LEFT(E$_firstRowCertificado,9))=BASE!\$EI\$2,COUNTIFS(BASE!\$AM\$$_firstRowBase:\$AM\$$_lastRowBase,B$_firstRowCertificado,BASE!\$AT\$$_firstRowBase:\$AT\$$_lastRowBase,C$_firstRowCertificado,BASE!\$AR\$$_firstRowBase:\$AR\$$_lastRowBase,LEFT(D$_firstRowCertificado,4),BASE!\$Z\$$_firstRowBase:\$Z\$$_lastRowBase,\$X\$4),0)
        ''';
    // MONTO OCUPADO
    ...
    page.getRangeByIndex(_firstRowCertificado, _column + 4).formula =
        '''=IF(TRIM(LEFT(E$_firstRowCertificado,9))=BASE!\$EI\$2,COUNTIFS(BASE!\$AM\$$_firstRowBase:\$AM\$$_lastRowBase,B$_firstRowCertificado,BASE!\$AT\$$_firstRowBase:\$AT\$$_lastRowBase,C$_firstRowCertificado,BASE!\$AR\$$_firstRowBase:\$AR\$$_lastRowBase,LEFT(D$_firstRowCertificado,4),BASE!\$Z\$$_firstRowBase:\$Z\$$_lastRowBase,\$Z\$4),0)
        ''';
