...
class CertificadoModel extends CertificadoEntity {
  ...
  factory CertificadoModel.fromJson(Map<String, dynamic> json) =>
      CertificadoModel(
        ...
        saldo: double.parse(json["saldo"] ?? 0),
        devengado: double.parse(json["devengado"] ?? 0),
        enero: double.parse(json["enero"] ?? 0),
        febrero: double.parse(json["febrero"] ?? 0),
        marzo: double.parse(json["marzo"] ?? 0),
        abril: double.parse(json["abril"] ?? 0),
        mayo: double.parse(json["mayo"] ?? 0),
        junio: double.parse(json["junio"] ?? 0),
        julio: double.parse(json["julio"] ?? 0),
        agosto: double.parse(json["agosto"] ?? 0),
        setiembre: double.parse(json["setiembre"] ?? 0),
        octubre: double.parse(json["octubre"] ?? 0),
        noviembre: double.parse(json["noviembre"] ?? 0),
        diciembre: double.parse(json["diciembre"] ?? 0),
      );
